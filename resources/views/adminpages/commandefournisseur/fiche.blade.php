            ...
            <div class="card-body">
                <div class="mt-4">
                    <div class="alert alert-warning" role="alert">
                        Vous êtes en train de passer votre commande avec votre fournisseur  <strong style="text-transform: uppercase;font-style: italic;font-size: 2em;">####</strong>
                    </div>
                        ...
                        <table class="table table-bordered dt-responsive  nowrap w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th>Date Expédition Commande</th>
