            ...
            <div class="card-body">
                <div class="mt-4">
                    <div class="alert alert-warning" role="alert">
                        Vous êtes en train de passer votre commande avec votre fournisseur  <strong style="text-transform: uppercase;font-style: italic;font-size: 2em;">{{retreiveFournisseur(session()->get('keyf'))}}</strong>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-lg" id="quantiteSeuil" type="text" name="quantiteSeuil">
                                </div>                                              
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-lg" id="quantiteAlerte" type="text" name="quantiteAlerte">
                                </div>
                        </div>
                            <div class="col-sm-6">
