    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('famille.update',$famille->uuid)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="results">
                    ...
                    <div class="row">
                        <div class="mt-4">
                            <a href="{{route('famille.index')}}" class="btn btn-primary waves-effect waves-light btn-sm">Aller &agrave; la liste <i class="mdi mdi-arrow-left ms-1"></i></a>
                        </div>
                        <br>
                        <div class="col-sm-6">
                            <div class="mb-3">
