                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="{{route('famille.imprimeFournisseur')}}" class="btn btn-outline-info waves-effect waves-light btn-sm"><i class="bx bx-printer"></i>Imprimer
                        </a>
                ...
                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                    ...
                    <tbody>
                        ...
                        @foreach ($familles as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('famille.edit',$item->uuid)}}" class="btn btn-success waves-light waves-effect"><i class="mdi mdi-pencil"></i></a>
                 ...
                 <div style="text-align: center;">
                    <nav aria-label="...">
                            <ul class="pagination">
                              <li class="page-item">
                                <a class="page-link" href="{{$familles->previousPageUrl()}}">Pr&eacute;c&eacute;dent</a>
                           
                              </li>
                              <li class="page-item">
                                <a class="page-link" href="{{$familles->nextPageUrl()}}">Suivant</a>
                              </li>
                            </ul>
                          </nav>  
                </div>
