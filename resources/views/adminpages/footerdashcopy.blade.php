...
<script>
    ...
    $(document).ready(function(){
        ...
        var html = '';
        html += '<tr id="'+count+'">';
        html +='<td><select class="form-control select2" data-sub_user_id="'+count+'" name="item_produit[]" required> <?php  echo renvoiProduits(); ?> </select></td>';
    ...
    $('.ajout').click(function(){
        ...
        var html = '';
        html += '<tr id="'+compt+'">';
        var html = '<tr id="'+compt+'"><td><select class="form-control select2 produ" data-sub_user_id="'+compt+'" name="item_produitv[]" required><option value="Veuillez Sélectionner">Veuillez Sélectionner</option>' + produits.map(produit => '<option value="'+produit.id+'">'+produit.nom+'</option>').join('') + '</select></td>';
        html +='<td><input type="text"  name="item_quantitev[]" class="form-control item_quantite" required/></td>';
        html +='<td><input type="text"  name="item_prixunitairev[]" class="form-control item_prixunitairev" required/></td>';
