    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('patient.update',$patient['uuid']) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="results">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="nom" placeholder="Entrer le nom" value="{{$patient['nom']}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="prenom" placeholder="Entrer la prenom" value="{{$patient['prenom']}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="telephone" name="telephone" type="text" class="form-control" placeholder="Entrer le téléphone" value="{{$patient['telephone']}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" name="email" type="text" class="form-control" placeholder="Entrer l'email" value="{{$patient['email']}}">
