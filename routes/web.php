...
Route::post('/fetch-famille-formes',[FamilleController::class,'fetchFamilleForme'])->name('famille.fetchFamilleForme');
...
Route::get('/consultation-commande-fournisseur',[FournisseurController::class,'indexCommandesFournisseur'])->name('fournisseur.indexCommandesFournisseur');
...
Route::get('/edit-fournissuer',[FournisseurController::class,'edit'])->name('fournisseur.edit');
Route::get('/edit-fournissuer-produit-etatcommande/{id}',[FournisseurController::class,'retreiveInformationsFournisseurProduit'])->name('fournisseur.retreiveInformationsFournisseurProduit');
Route::put('/update-fournissuer',[FournisseurController::class,'update'])->name('fournisseur.update');
Route::get('/delete-fournissuer/{id}',[FournisseurController::class,'destroy'])->name('fournisseur.delete');
Route::get('/imprime-etat-fournissuer',[FournisseurController::class,'imprimeFournisseur'])->name('fournisseur.imprimeFournisseur');
Route::post('/commandes/fetch-produit-quantite',[FournisseurController::class,'fetchProduitQuantiteCommandee'])->name('fournisseur.fetchProduitQuantiteCommandee');
Route::post('/commandes/fetch-fournisseur',[FournisseurController::class,'fetchFoirnisseurId'])->name('fournisseur.fetchFoirnisseurId');
Route::post('/commandes/fetch-numero-commande',[FournisseurController::class,'fetchNumeroCommande'])->name('fournisseur.fetchNumeroCommande');
...
Route::get('/liste-des-clients',[ClientController::class,'index'])->name('client.liste');
Route::get('/creer-client',[ClientController::class,'create'])->name('client.create');
Route::post('/store-client',[ClientController::class,'store'])->name('client.store');
Route::get('/modifier-client',[ClientController::class,'edit'])->name('client.edit');
...
Route::get('/creer-commandeclient',[CommandeClientController::class,'create'])->name('commandeclient.create');
Route::post('/store-commandeclient',[CommandeClientController::class,'store'])->name('commandeclient.store');
